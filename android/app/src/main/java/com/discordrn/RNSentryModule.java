...
public class RNSentryModule extends ReactContextBaseJavaModule {
    ...
    private Object frameMetricsAggregator = null;
    ...
    public void fetchNativeRelease(Promise promise) {
        ...
        release.putString("id", "com.hammerandchisel.discord");
        release.putString("version", "");
        release.putString("build", "");
    ...
    public void fetchNativeAppStart(Promise promise) {
        ...
        appStart.putDouble("appStartTime", 0.0);
        appStart.putBoolean("isColdStart", true);
        appStart.putBoolean("didFetchAppStart", true);
